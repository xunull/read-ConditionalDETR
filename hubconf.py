...
def conditional_detr_resnet50(pretrained=False, num_classes=91, return_postprocessor=False):
    ...
    if pretrained:
        checkpoint = torch.hub.load_state_dict_from_url(
            url="https://github.com/DeppMeng/ConditionalDETR/releases/download/v1.0/ConditionalDETR_r50_epoch50.pth",
...
def conditional_detr_resnet50_dc5(pretrained=False, num_classes=91, return_postprocessor=False):
    ...
    if pretrained:
        checkpoint = torch.hub.load_state_dict_from_url(
            url="https://github.com/DeppMeng/ConditionalDETR/releases/download/v1.0/ConditionalDETR_r50dc5_epoch50.pth",
            map_location="cpu", check_hash=True
        )
        model.load_state_dict(checkpoint["model"])
    if return_postprocessor:
...
def conditional_detr_resnet101(pretrained=False, num_classes=91, return_postprocessor=False):
    ...
    if pretrained:
        checkpoint = torch.hub.load_state_dict_from_url(
            url="https://github.com/DeppMeng/ConditionalDETR/releases/download/v1.0/ConditionalDETR_r101_epoch50.pth",
            map_location="cpu", check_hash=True
        )
        model.load_state_dict(checkpoint["model"])
    if return_postprocessor:
...
def conditional_detr_resnet101_dc5(pretrained=False, num_classes=91, return_postprocessor=False):
    ...
    if pretrained:
        checkpoint = torch.hub.load_state_dict_from_url(
            url="https://github.com/DeppMeng/ConditionalDETR/releases/download/v1.0/ConditionalDETR_r101dc5_epoch50.pth",
            map_location="cpu", check_hash=True
        )
        model.load_state_dict(checkpoint["model"])
    if return_postprocessor:
